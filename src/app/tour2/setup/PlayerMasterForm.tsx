 ...
 */
export default function PlayerMasterForm() {
  ...
  if (!user) {
    return (
      <div className="mt-6 rounded-2xl bg-black/[0.02] p-6 text-center">
  ...
  return (
    <section className="mt-12">
      <h2 className={sectionH}>{t("tour.pmTitle")}</h2>
      <p className="mt-2 max-w-2xl text-[13px] leading-relaxed text-neutral-500">{t("tour.pmIntro")}</p>

      <div className="mt-4 grid gap-4">
        {/* ── Dokumente & Ablauf (owner-only) ─────────────────────────────── */}
        <div className={card}>
          <h3 className="text-[13px] font-bold text-neutral-900">{t("tour.pmDocsTitle")}</h3>
          <p className="mt-1 text-[12px] text-neutral-500">{t("tour.pmDocsHint")}</p>
          <div className="mt-3 grid gap-2 sm:grid-cols-2">
            ...
            <label className="flex items-center gap-2 pt-6"><input type="checkbox" checked={docs.insurance_international === true} onChange={(e) => setDocs({ ...docs, insurance_international: e.target.checked })} className="h-4 w-4" /><span className="text-[13px] text-neutral-700">{t("tour.pmInsuranceInternational")}</span></label>
        ...
        <div className={card}>
          <h3 className="text-[13px] font-bold text-neutral-900">{t("tour.pmEquipTitle")}</h3>
          <p className="mt-1 text-[12px] text-neutral-500">{t("tour.pmEquipHint")}</p>
        ...
        <div className={card}>
          <h3 className="text-[13px] font-bold text-neutral-900">{t("tour.pmEmergTitle")}</h3>
          <p className="mt-1 text-[12px] text-neutral-500">{t("tour.pmEmergHint")}</p>
