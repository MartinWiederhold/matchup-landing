      ...
      <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-5">
        ...
        <div className="divide-y divide-black/[0.06]">
          ...
          <div className="py-2.5">
            ...
            {directorName && (
              <p className="mt-2 text-[12px] text-neutral-500">{t("tour.ovNoteDirector")}: <span className="font-semibold text-neutral-700">{directorName}</span> · <a href="/tour2/wildcards" className="font-semibold text-matchup hover:underline">{t("tour.wildcardsOpen")} →</a></p>
            )}
