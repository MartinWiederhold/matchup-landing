    ...
    <div className="mt-8 space-y-2">
      ...
      {entries.length === 0 ? (
        <div className="mt-8 rounded-2xl bg-black/[0.02] ring-1 ring-black/5 px-6 py-10 text-center">
          ...
          <Link href="/tour2/browse" className="mt-6 inline-flex rounded-full bg-matchup px-6 py-3.5 text-sm font-bold text-white transition-colors hover:bg-matchup-hover">
