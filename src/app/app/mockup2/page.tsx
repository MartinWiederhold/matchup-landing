    ...
    <div className="min-h-[100dvh] w-full bg-white text-black">
      <div className="relative mx-auto min-h-[100dvh] w-full max-w-[430px] overflow-hidden bg-white px-5 pb-32 pt-[max(20px,env(safe-area-inset-top))]">
        ...
        <header className="flex items-center justify-between pt-2">
          <img src="https://i.pravatar.cc/160?img=47" alt="" className="h-14 w-14 rounded-full object-cover" />
        ...
        <div className="mt-6 rounded-[24px] bg-black/[0.035] p-5">
          <p className="text-[17px] text-neutral-400">Start a post</p>
          <div className="mt-6 flex items-center justify-between">
            <span className="flex items-center gap-2 rounded-full bg-black/[0.05] py-2.5 pl-3 pr-4 text-sm font-semibold text-black">
            ...
            <div className="flex gap-2.5">
              <button type="button" className="flex h-11 w-11 items-center justify-center rounded-full bg-black/[0.05] text-black">
