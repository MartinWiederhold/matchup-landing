export const landing = {
  de: {
    ...
    worldCopy: "Von Zürich aus: zehn echte Turniere, jede Flugroute, jeder Kilometer, jeder Franken - alles geplant, bevor du packst.",
    worldStart: "Start",
    worldStops: "Turniere",
  ...
  en: {
    ...
    worldCopy: "From Zurich: ten real tournaments, every flight route, every kilometre, every franc - planned before you pack.",
    worldStart: "Start",
